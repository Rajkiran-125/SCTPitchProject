...
@Component({
  selector: 'app-report-batch-wise-status',
  templateUrl: './report-batch-wise-status.component.html',
  styleUrls: ['./report-batch-wise-status.component.scss']
})
export class ReportBatchWiseStatusComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.common.hubControlEvent('BatchWiseStatusReport','click','pageload','pageload','','ngOnInit');
    ...
    if(this.type == 'batch-wise-status-report'){
...
this.getFilter();
this.feildChooser()
this.common.hubControlEvent('BatchWiseStatusReport','click','pageloadend','pageloadend','','ngOnInit');
  ...
  feildChooser() {
    ...
    this.common.hubControlEvent('BatchWiseStatusReport','click','','',JSON.stringify(obj),'feildChooser');
  ...
  getFilter() {
    this.common.hubControlEvent('BatchWiseStatusReport','click','','','','getFilter');
  ...
  searchHawker() {
    ...
    this.requestObj = {
      data: {
        spname: 'usp_unfyd_batch_wise_mis_report',
        parameters: {
          FromDate: a,
          ToDate :b
        }
    ...
    this.common.hubControlEvent('BatchWiseStatusReport','click','','',JSON.stringify(this.requestObj),'searchHawker');
  ...
  reset(){
    this.common.hubControlEvent('BatchWiseStatusReport','click','','','','reset');
