...
export class ReportTrainingComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.common.hubControlEvent('TrainingReport','click','pageload','pageload','','ngOnInit');
...
this.getFilter();
this.feildChooser()
this.common.hubControlEvent('TrainingReport','click','pageloadend','pageloadend','','ngOnInit');
  ...
  feildChooser() {
    ...
    this.common.hubControlEvent('TrainingReport','click','','',JSON.stringify(obj),'feildChooser');
  ...
  getFilter() {
    this.common.hubControlEvent('TrainingReport','click','','','','getFilter');
  ...
  searchHawker() {
    ...
    this.requestObj = {
      data: {
        spname: 'usp_unfyd_training_report',
        parameters: {
          FromDate: a,
          ToDate :b
        }
    ...
    this.common.hubControlEvent('TrainingReport','click','','',JSON.stringify(this.requestObj),'searchHawker');
      ...
      if (res.code == 200) {
        ...
        for (let data of tempRes) {
          var newObj = {
            ...
            "Training Batch ID": data['Training Batch ID'],
            "Training Center": data['Training Center'],
            "Training Start Date": data['Training Start Date'],
            "Training End Date": data['Training End Date'],
  ...
  reset(){
    this.common.hubControlEvent('TrainingReport','click','','','','reset');
