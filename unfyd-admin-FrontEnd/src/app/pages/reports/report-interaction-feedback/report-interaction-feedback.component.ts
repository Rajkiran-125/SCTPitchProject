...
@Component({
  selector: 'app-report-interaction-feedback',
  templateUrl: './report-interaction-feedback.component.html',
  styleUrls: ['./report-interaction-feedback.component.scss'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE, MAT_MOMENT_DATE_ADAPTER_OPTIONS] },
    { provide: MAT_MOMENT_DATE_ADAPTER_OPTIONS, useValue: { useUtc: true } }
  ]
})
export class ReportInteractionFeedbackComponent implements OnInit {
  ...
  ngOnInit() {
    this.common.hubControlEvent('InteractionFeedbackReport','click','pageload','pageload','','ngOnInit');

    this.filter = false;
    this.userDetails = this.auth.getUser();
    this.type = this.router.url.substring(1, this.router.url.length);
    if (this.type == "report-interaction-feedback") {
    ...
    this.common.hubControlEvent('InteractionFeedbackReport','click','pageloadend','pageloadend','','ngOnInit');

  }
  loadReportsData() {
    this.common.hubControlEvent('loadReportsData','click','','','','loadReportsData');
  ...
  loadFilter() {
    this.common.hubControlEvent('loadReportsData','click','','','','loadFilter');
  ...
  getData(currentpage, itemsPerPage, date) {
    ...
    let requestObj = {
      data: {
        spname: "UNFYD_ADM_GETBOTFEEDBACK",
        parameters: {
    ...
    this.common.hubControlEvent('loadReportsData','click','','',JSON.stringify(requestObj),'getData');
  ...
  pageChange(currentpage) {
    this.common.hubControlEvent('loadReportsData','click','','',JSON.stringify(currentpage),'pageChange');
  ...
  getFilter() {
    this.common.hubControlEvent('loadReportsData','click','','','','getFilter');
  ...
  feildChooser() {
    ...
    this.common.hubControlEvent('loadReportsData','click','','',JSON.stringify(obj),'feildChooser');
