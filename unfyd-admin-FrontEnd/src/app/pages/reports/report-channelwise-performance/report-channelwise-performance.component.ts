...
@Component({
  selector: 'app-report-channelwise-performance',
  templateUrl: './report-channelwise-performance.component.html',
  styleUrls: ['./report-channelwise-performance.component.scss']
})
export class ReportChannelwisePerformanceComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.common.hubControlEvent('ChannelwisePerformanceReport','click','pageload','pageload','','ngOnInit');
    ...
    if(this.type == 'channelwise-performance-report'){
...
this.getFilter();
this.feildChooser()
this.common.hubControlEvent('ChannelwisePerformanceReport','click','pageloadend','pageloadend','','ngOnInit');
  ...
  feildChooser() {
    ...
    this.common.hubControlEvent('ChannelwisePerformanceReport','click','','',JSON.stringify(obj),'feildChooser');
  ...
  getFilter() {
    this.common.hubControlEvent('ChannelwisePerformanceReport','click','','','','getFilter');
  ...
  searchHawker() {
    ...
    this.requestObj = {
      data: {
        spname: 'UNFYD_ADM_RPT_V1_CHANNELWISE_SUMMARY',
        parameters: {
          FromDate: a,
          ToDate :b,
          flag : "BIND_DATA"
    ...
    this.common.hubControlEvent('ChannelwisePerformanceReport','click','','',JSON.stringify(this.requestObj),'searchHawker');
  ...
  reset(){
    this.common.hubControlEvent('ChannelwisePerformanceReport','click','','','','reset');
