...
@Component({
  selector: 'app-report-videosession-details',
  templateUrl: './report-videosession-details.component.html',
  styleUrls: ['./report-videosession-details.component.scss']
})
export class ReportVideosessionDetailsComponent implements OnInit {
...
ngOnInit(): void {
  ...
  if(this.type == 'videosession-details-report'){
    this.type = "VideosessionDetailsReport"
  }
