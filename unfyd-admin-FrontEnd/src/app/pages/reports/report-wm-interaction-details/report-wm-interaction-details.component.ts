...
@Component({
  selector: 'app-report-wm-interaction-details',
  templateUrl: './report-wm-interaction-details.component.html',
  styleUrls: ['./report-wm-interaction-details.component.scss']
})
export class ReportWmInteractionDetailsComponent implements OnInit {
...
ngOnInit(): void {
  ...
  if(this.type == 'wm-interaction-details-report'){
    this.type = "WMInteractiondetailsReport"
  }
