...
@Component({
  selector: 'app-report-interaction-type',
  templateUrl: './report-interaction-type.component.html',
  styleUrls: ['./report-interaction-type.component.scss'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE, MAT_MOMENT_DATE_ADAPTER_OPTIONS] },
    { provide: MAT_MOMENT_DATE_ADAPTER_OPTIONS, useValue: { useUtc: true } }
  ]
})
export class ReportInteractionTypeComponent implements OnInit {
  ...
  ngOnInit() {
    this.common.hubControlEvent('InteractionType','click','pageload','pageload','','ngOnInit');

    this.filter = false;
    this.userDetails = this.auth.getUser();
    this.type = this.router.url.substring(1, this.router.url.length);
    if (this.type == "report-interaction-type") {
    ...
    this.common.hubControlEvent('InteractionType','click','pageloadend','pageloadend','','ngOnInit');

  }
  loadReportsData() {
    this.common.hubControlEvent('InteractionType','click','','','','loadReportsData');
  ...
  loadFilter() {
    this.common.hubControlEvent('InteractionType','click','','','','loadFilter');
  ...
  getData(currentpage, itemsPerPage, date) {
    ...
    this.common.hubControlEvent('InteractionType','click','','',JSON.stringify(requestObj),'getData');
  ...
  pageChange(currentpage) {
    this.common.hubControlEvent('InteractionType','click','','',JSON.stringify(currentpage),'pageChange');
  ...
  getFilter() {
    this.common.hubControlEvent('InteractionType','click','','','','getFilter');
  ...
  feildChooser() {
    ...
    this.common.hubControlEvent('InteractionType','click','','',JSON.stringify(obj),'feildChooser');
  ...
  htmlDecode(data: any) {
    this.common.hubControlEvent('InteractionType','click','','',JSON.stringify(data),'htmlDecode');
