...
@Component({
  selector: 'app-report-offline-message',
  templateUrl: './report-offline-message.component.html',
  styleUrls: ['./report-offline-message.component.scss'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE, MAT_MOMENT_DATE_ADAPTER_OPTIONS] },
    { provide: MAT_MOMENT_DATE_ADAPTER_OPTIONS, useValue: { useUtc: true } }
  ]
})
export class ReportOfflineMessageComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.common.hubControlEvent('OfflineMessageReport','click','pageload','pageload','','ngOnInit');

    this.userDetails = this.auth.getUser();
    this.proccessId = this.userDetails.Processid;
    this.type = this.router.url.substring(1, this.router.url.length);
    if (this.type == "report-offline-message") {
    ...
    this.common.hubControlEvent('OfflineMessageReport','click','pageloadend','pageloadend','','ngOnInit');

  }

  loadAgentFilter() {
    this.common.hubControlEvent('OfflineMessageReport','click','','','','loadAgentFilter');
  ...
  loadReportsData() {
    this.common.hubControlEvent('OfflineMessageReport','click','','','','loadReportsData');
  ...
  getFilter() {
    this.common.hubControlEvent('OfflineMessageReport','click','','','','getFilter');
  ...
  feildChooser() {
    ...
    this.common.hubControlEvent('OfflineMessageReport','click','','','','feildChooser');
  ...
  searchHawker(currentpage, itemsPerPage, date) {
    ...
    this.requestObj = {
      data: {
        ...
        parameters: {
          ...
          UID: this.filter == false ? undefined : this.UID == null ? undefined : this.UID,
    ...
    this.common.hubControlEvent('OfflineMessageReport','click','','',JSON.stringify(this.requestObj),'searchHawker');
  ...
  htmlDecode(data: any) {
    this.common.hubControlEvent('OfflineMessageReport','click','','',JSON.stringify(data),'htmlDecode');
  ...
  pageChange(currentpage) {
    this.common.hubControlEvent('OfflineMessageReport','click','','',JSON.stringify(currentpage),'pageChange');
  ...
  reset() {
    this.common.hubControlEvent('OfflineMessageReport','click','','','','reset');
