...
@Component({
  selector: 'app-report-hsm-details',
  templateUrl: './report-hsm-details.component.html',
  styleUrls: ['./report-hsm-details.component.scss']
})
export class ReportHsmDetailsComponent implements OnInit {
...
ngOnInit(): void {
  ...
  if(this.type == 'hsm-details-report'){
    this.type = "HSMDetailsReport"
  }
