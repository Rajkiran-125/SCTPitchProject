...
@Component({
  selector: 'app-report-not-ready',
  templateUrl: './report-not-ready.component.html',
  styleUrls: ['./report-not-ready.component.scss'],
  providers: [
    { provide: DateAdapter, useClass: MomentDateAdapter, deps: [MAT_DATE_LOCALE, MAT_MOMENT_DATE_ADAPTER_OPTIONS] },
    { provide: MAT_MOMENT_DATE_ADAPTER_OPTIONS, useValue: { useUtc: true } }
  ]
})
export class ReportNotReadyComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.common.hubControlEvent('NotReadyReport','click','pageloadend','pageloadend','','ngOnInit');

  }
  loadAgentFilter() {
    this.common.hubControlEvent('NotReadyReport','click','','','','loadAgentFilter');
  ...
  loadReportsData() {
    this.common.hubControlEvent('NotReadyReport','click','','','','loadReportsData');
  ...
  getFilter() {
    this.common.hubControlEvent('NotReadyReport','click','','','','getFilter');
  ...
  feildChooser() {
    ...
    this.common.hubControlEvent('NotReadyReport','click','','',JSON.stringify(obj),'feildChooser');
  ...
  searchHawker(currentpage, itemsReportPerPage, date) {
    ...
    this.requestObj = {
      data: {
        spname: "UNFYD_ADM_RPT_V1_NOTREADY",
        parameters: {
          ...
          REASON: this.filter == false ? undefined : this.Reason == null ? undefined : this.Reason,
          DURATION: this.filter == false ? undefined : this.Duration == null ? undefined : this.Duration,
          LOGINID: this.filter == false ? undefined : this.LoginId == null ? undefined : this.LoginId,
          PAGESIZE: itemsReportPerPage,
          PAGENO: currentpage
        }
      }
    }
    this.common.hubControlEvent('NotReadyReport','click','','',JSON.stringify(this.requestObj),'searchHawker');
  ...
  pageChange(currentpage) {
    this.common.hubControlEvent('NotReadyReport','click','','',JSON.stringify(currentpage),'pageChange');
  ...
  htmlDecode(data: any) {
    this.common.hubControlEvent('NotReadyReport','click','','',JSON.stringify(data),'htmlDecode');
  ...
  reset() {
    this.common.hubControlEvent('NotReadyReport','click','','','','reset');
