...
@Component({
  ...
  template: `
    <div class="password-strength" style = " padding: 0px; margin: 0px;font-size: 12px ; text-align: left">
        <ul>
          <div class="pass-strength-ttl">Your Password Must </div>
          <li *ngIf="passwordPolicyList.minMaxChar">

            <span><i [ngClass]="result[0]==true ? 'icon-happy_smile green-color normal-font' : 'icon-unhapy_smile red-color normal-font'"></i></span>
            <span class="li-subtext">Be {{min ?min :8}} to {{max ? max:15}} Characters long</span>
          </li>


          <li *ngIf="passwordPolicyList.oneUpperCase">
            <span><i [ngClass]="result[1]==true ? 'icon-happy_smile green-color normal-font' : 'icon-unhapy_smile red-color normal-font'"></i></span>
            <span class="li-subtext">Have at least one upper case letter</span>
          </li>
          <li *ngIf="passwordPolicyList.oneNumber">
            <span><i [ngClass]="result[2]==true ? 'icon-happy_smile green-color normal-font' : 'icon-unhapy_smile red-color normal-font'"></i></span>
            <span class="li-subtext">Have at least one Number</span>
          </li>
          <li *ngIf="passwordPolicyList.oneSpecialChar">
            <span><i [ngClass]="result[3]==true ? 'icon-happy_smile green-color normal-font' : 'icon-unhapy_smile red-color normal-font'"></i></span>
            <span class="li-subtext">Have at least one special Character</span>
          </li>
...
export class StrengthCheckerComponent implements OnChanges, OnInit {
  @Input() public passwordMatch: boolean = false;
