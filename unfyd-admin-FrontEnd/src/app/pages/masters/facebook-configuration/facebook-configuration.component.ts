...
export class FacebookConfigurationComponent implements OnInit {
  ...
  deleteChannel(data){
    ...
    editPage(data){
      ...
      this.router.navigate(['/masters/channel-configuration/facebook-configuration/facebook-details', this.activatedRoute.snapshot.paramMap.get('id'), 'update', data.ChannelSrcID])
    }
