...
@Component({
  selector: 'app-twitter-dm-auth',
  templateUrl: './twitter-dm-auth.component.html',
  styleUrls: ['./twitter-dm-auth.component.scss']
})
export class TwitterDmAuthComponent implements OnInit {
  key: any;
  hide = true;
  form: FormGroup;
      ...
      this.api.post('index', obj).subscribe((res: any) => {
        if (res.code == 200) {
          ...
          if (updateData.length - 1 == cntr) {
            ...
            if(event == 'save') this.router.navigate(['masters/channel-configuration/twitter-dm/twitter-dm-auth', this.activatedRoute.snapshot.paramMap.get('id'), 'update', this.activatedRoute.snapshot.paramMap.get('uniqueid')]);
            else if(event == 'next')this.router.navigate(['masters/channel-configuration/twitter-dm/twitter-dm-api', this.activatedRoute.snapshot.paramMap.get('id'), 'update', this.activatedRoute.snapshot.paramMap.get('uniqueid')]);
