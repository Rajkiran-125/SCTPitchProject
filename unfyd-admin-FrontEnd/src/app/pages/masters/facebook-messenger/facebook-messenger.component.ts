...
export class FacebookMessengerComponent implements OnInit {
  ...
  deleteChannel(data){
    ...
    editPage(data){
      ...
      this.router.navigate(['/masters/channel-configuration/facebook-messenger/facebook-messenger-details', this.activatedRoute.snapshot.paramMap.get('id'), 'update', data.ChannelSrcID])
    }
