...
@Component({
  selector: 'app-twitter-configuration',
  templateUrl: './twitter-configuration.component.html',
  styleUrls: ['./twitter-configuration.component.scss']
})
export class TwitterConfigurationComponent implements OnInit {
    key: any;
    form: FormGroup;
    ...
    deleteChannel(data){
      ...
      editPage(data){
        ...
        this.router.navigate(['/masters/channel-configuration/twitter-configuration/twitter-details', this.activatedRoute.snapshot.paramMap.get('id'), 'update', data.ChannelSrcID])
      }
