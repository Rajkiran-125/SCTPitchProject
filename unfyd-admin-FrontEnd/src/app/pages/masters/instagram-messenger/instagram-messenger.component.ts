...
@Component({
  selector: 'app-instagram-messenger',
  templateUrl: './instagram-messenger.component.html',
  styleUrls: ['./instagram-messenger.component.scss']
})
export class InstagramMessengerComponent implements OnInit {
  key: any;
  form: FormGroup;
  ...
  deleteChannel(data){
    ...
    editPage(data){
      this.router.navigate(['/masters/channel-configuration/instagram-post/instagram-post-details', this.activatedRoute.snapshot.paramMap.get('id'), 'update', data.ChannelSrcID])
    }
