...
@Component({
  selector: 'app-instagram-messenger-details',
  templateUrl: './instagram-messenger-details.component.html',
  styleUrls: ['./instagram-messenger-details.component.scss']
})
export class InstagramMessengerDetailsComponent implements OnInit {
  key: any;
  hide = true;
  form: FormGroup;
                  ...
                  this.api.post('index', obj).subscribe((res: any) => {
                    if (res.code == 200) {
                      if (temp.length - 1 == counter) {
                        this.loader = false;
                        if(event == 'save') {this.router.navigate(['masters/channel-configuration/instagram-post/instagram-post-details', this.activatedRoute.snapshot.paramMap.get('id'), 'update', ChSrcId]);  this.isUpdate = 'true';}
                        else if(event == 'next')this.router.navigate(['masters/channel-configuration/instagram-post/instagram-post-auth', this.activatedRoute.snapshot.paramMap.get('id'), 'update', ChSrcId]);
        ...
        this.api.post('index', obj).subscribe((res: any) => {
          if (res.code == 200) {
            ...
            if (counter == 0) {
              ...
              if(event == 'save') this.router.navigate(['masters/channel-configuration/instagram-post/instagram-post-details', this.activatedRoute.snapshot.paramMap.get('id'), 'update', this.activatedRoute.snapshot.paramMap.get('uniqueid')]);
              else if(event == 'next')this.router.navigate(['masters/channel-configuration/instagram-post/instagram-post-auth', this.activatedRoute.snapshot.paramMap.get('id'), 'update', this.activatedRoute.snapshot.paramMap.get('uniqueid')]);
