...
export class HawkerDetailsComponent implements OnInit {
  ...
  myTraining = [
    {
      training_Program: "Hawker Training",
      duration: "On 15 Dec 2021 to 20 Dec 2021",
      location: "At location Name",
      status: "Not Completed",
    },
    {
      training_Program: "Soft Skills Training",
      duration: "On 15 Dec 2021 to 20 Dec 2021",
      location: "At location Name",
      status: "Completed",
    },
  ...
  myGrievances = [
    {
      role: "Passenger",
      title: "Misbehave with Passanger",
      msg: "On 15 Dec 2021 to 20 Dec 2021 On 15 Dec 2021 to 20 Dec 2021",
      time: "Paid on 15 Oct 2021 11.24.25",
      status: "Pending",
    },
    {
  ...
  ngOnInit(): void {
    ...
    this.common.hawkerIDChanged(this.contactId)
    ...
    this.api.post('index', doc).subscribe(res => {
      if (res.error == false) {
    ...
    this.api
      ...
      .subscribe(res => {
        if (res.error == false) {
          ...
          this.registrationStatus = temp?.RegistrationStatus;
        }
      })
      .add(() => {
        let data1 = {
  ...
  getData() {
    ...
    this.api.post(endPoint, data1).subscribe(res => {
      if (res.error == false) {
        this.loader = false;
        var temp = res.results.data[0];
        this.RegistrationNo = temp.RegistrationNo;
        this.IssuingDate = temp?.ApprovedDateTime
