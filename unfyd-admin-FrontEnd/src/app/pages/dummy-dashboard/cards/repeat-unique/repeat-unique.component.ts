...
@Component({
  selector: 'app-repeat-unique',
  templateUrl: './repeat-unique.component.html',
  styleUrls: ['./repeat-unique.component.scss']
})
export class RepeatUniqueComponent implements OnInit {
  ...
  constructor(public auth: AuthService,private api: ApiService,public common: CommonService,private router :Router) { }
