...
@Component({
  selector: 'app-top-disposition',
  templateUrl: './top-disposition.component.html',
  styleUrls: ['./top-disposition.component.scss']
})
export class TopDispositionComponent implements OnInit {
  loader: boolean = false;
  spname = "usp_unfyd_hub_dashboard_graphs";
  innerSpName = "GET_TOP_DISPOSITION";
  flag = "DAY";
  ...
  reloadData() {
    this.common.hubControlEvent('Dashboard','click','pageloadend','pageloadend','','reloadData');
