...
@Component({
  selector: 'app-dashboard-hawker-application',
  templateUrl: './dashboard-hawker-application.component.html',
  styleUrls: ['./dashboard-hawker-application.component.scss']
})
export class DashboardHawkerApplicationComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getInformation("usp_unfyd_hawker_application_dashboard", "Day")
    ...
    if (direction == 'next') {
      if (this.selectedGrievance == 'Day') {
        ...
        if (this.hawkerAppDate.getMonth() == 11) {
          ...
          this.getInformation("usp_unfyd_hawker_application_dashboard", "Month")
        ...
        this.getInformation("usp_unfyd_hawker_application_dashboard", "Year")
